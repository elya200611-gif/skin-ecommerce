...
export const PRODUCTS: Product[] = [
  {
    ...
    price: 4500,
    category: 'soft',
    image: '/catalog pic 1 default.webp',
    imageStatic: '/catalog pic 1 default.webp',
    imageHover: '/catalog pic 1 hover.webp',
  ...
  },
  {
    ...
    price: 8500,
    category: 'alt',
    image: '/catalog pic 2 default.webp',
    imageStatic: '/catalog pic 2 default.webp',
    imageHover: '/catalog pic 2 hover.webp',
  ...
  },
  {
    ...
    price: 5800,
    category: 'street',
    image: '/catalog pic 3 default.webp',
    imageStatic: '/catalog pic 3 default.webp',
    imageHover: '/catalog pic 3 hover.webp',
  ...
  },
  {
    ...
    price: 3200,
    category: 'goblin',
    image: '/catalog pic 4 default.webp',
    imageStatic: '/catalog pic 4 default.webp',
    imageHover: '/catalog pic 4 hover.webp',
